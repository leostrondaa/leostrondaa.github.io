...
var app = (function () {
    ...
    /* Display.svelte generated by Svelte v3.59.2 */

    const file$2 = "Display.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "input-text svelte-f5yl63");
    			input.readOnly = true;
    			attr_dev(input, "aria-label", "Display da calculadora");
    			add_location(input, file$2, 5, 2, 122);
    			attr_dev(div, "class", "display-container svelte-f5yl63");
    ...
    /* Key.svelte generated by Svelte v3.59.2 */
    const file$1 = "Key.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button0, "class", "btn svelte-ghtb0m");
    			add_location(button0, file$1, 10, 2, 216);
    			attr_dev(button1, "class", "btn svelte-ghtb0m");
    			add_location(button1, file$1, 11, 2, 279);
    			attr_dev(button2, "class", "btn svelte-ghtb0m");
    			add_location(button2, file$1, 12, 2, 342);
    			attr_dev(button3, "class", "btn operador svelte-ghtb0m");
    			add_location(button3, file$1, 13, 2, 405);
    			attr_dev(div0, "class", "button-row svelte-ghtb0m");
    			add_location(div0, file$1, 9, 0, 188);
    			attr_dev(button4, "class", "btn svelte-ghtb0m");
    			add_location(button4, file$1, 16, 2, 511);
    			attr_dev(button5, "class", "btn svelte-ghtb0m");
    			add_location(button5, file$1, 17, 2, 574);
    			attr_dev(button6, "class", "btn svelte-ghtb0m");
    			add_location(button6, file$1, 18, 2, 637);
    			attr_dev(button7, "class", "btn operador svelte-ghtb0m");
    			add_location(button7, file$1, 19, 2, 700);
    			attr_dev(div1, "class", "button-row svelte-ghtb0m");
    			add_location(div1, file$1, 15, 0, 483);
    			attr_dev(button8, "class", "btn svelte-ghtb0m");
    			add_location(button8, file$1, 22, 2, 806);
    			attr_dev(button9, "class", "btn svelte-ghtb0m");
    			add_location(button9, file$1, 23, 2, 869);
    			attr_dev(button10, "class", "btn svelte-ghtb0m");
    			add_location(button10, file$1, 24, 2, 932);
    			attr_dev(button11, "class", "btn operador svelte-ghtb0m");
    			add_location(button11, file$1, 25, 2, 995);
    			attr_dev(div2, "class", "button-row svelte-ghtb0m");
    			add_location(div2, file$1, 21, 0, 778);
    			attr_dev(button12, "class", "btn svelte-ghtb0m");
    			add_location(button12, file$1, 28, 2, 1101);
    			attr_dev(button13, "class", "btn operador svelte-ghtb0m");
    			add_location(button13, file$1, 29, 2, 1164);
    			attr_dev(button14, "class", "btn operador svelte-ghtb0m");
    			add_location(button14, file$1, 30, 2, 1236);
    			attr_dev(button15, "class", "btn C svelte-ghtb0m");
    			add_location(button15, file$1, 31, 2, 1308);
    			attr_dev(div3, "class", "button-row svelte-ghtb0m");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "card svelte-8ezl4a");
    			add_location(div0, file, 83, 4, 1747);
    			attr_dev(div1, "class", "container svelte-8ezl4a");
    			add_location(div1, file, 82, 2, 1718);
    			attr_dev(main, "class", "cor svelte-8ezl4a");
    			add_location(main, file, 81, 0, 1696);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
